...
import { nexusaiSymbol, check } from "../assets";
import Button from "./Button";
import { LeftCurve, RightCurve } from "./design/Collaboration";

/**
 * Collaboration Component
 * Displays details about collaboration features of an AI chat app.
 *
 * @returns {JSX.Element} The rendered Collaboration section.
 */
const Collaboration = () => {
  return (
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-4">
          ...
          >
            {/* Inner Circle with Nexus.ai Symbol */}
            <div
