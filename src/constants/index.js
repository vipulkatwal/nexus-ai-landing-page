...
// Notification icons for displaying in a list
export const notificationImages = [notification4, notification3, notification2];

// Placeholder for company logos (can be updated as needed)
export const companyLogos = [yourlogo, yourlogo, yourlogo, yourlogo, yourlogo];

// Nexus AI Services and their related icons
export const nexusaiServices = [
	"Photo generating",
	"Photo enhance",
	"Seamless Integration",
];
export const nexusaiServicesIcons = [
	recording03,
	recording01,
	disc02,
	chromecast,
...
// Roadmap for feature development with statuses
...
// Collaboration Text and Content for team-oriented features
...
// Collaboration Apps icons with dimensions
...
// Benefits of the app with related images and icons
