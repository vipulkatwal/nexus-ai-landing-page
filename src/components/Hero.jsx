...
/**
 * Hero Component
 * Represents the hero section of the page with a video, call to action, and other elements.
 *
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        >
          ...
          text-n-2 lg:mb-8"
          >
            Unleash the power of AI within Nexus.ai <br /> Upgrade your productivity
            with Nexus.ai, the open AI chat app.
          </p>
        ...
        {/* Hero Video and Generating Component */}
        <div
