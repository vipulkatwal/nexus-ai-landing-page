...
import { nexusai } from "../assets";
import { nexusAiSymbol } from "../assets";
...
/**
 * Header Component
 * Represents the navigation bar with mobile-friendly menu handling.
 *
...
const Header = () => {
  ...
  /**
   * Handles the click event to close the navigation menu if open.
   */
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={nexusAiSymbol} height={40} alt="nexus-ai" />
        </a>
