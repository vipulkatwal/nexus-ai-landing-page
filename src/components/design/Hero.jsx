...
// Component to render gradient bars for a decorative effect
export const Gradient = () => {
  return (
    <>
      {/* Top gradient bar */}
      <div className="relative z-1 h-6 mx-2.5 bg-n-11 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8" />
      {/* Bottom gradient bar with transparency */}
      <div className="relative z-1 h-6 mx-6 bg-n-11/70 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-20" />
    </>
  );
};

// Component to render a horizontal bottom line with "plus" SVG elements
export const BottomLine = () => {
  return (
    <>
      {/* Horizontal line for decorative purposes */}
...
// Component to render concentric rings
const Rings = () => {
  return (
    <>
      {/* Outer ring */}
...
// Component to render background circles with parallax effect
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      ...
      {/* Moving background gradient circles with parallax */}
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        {/* Various circles positioned and animated */}
